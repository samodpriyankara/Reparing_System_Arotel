                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title mb-2"><i class="mdi mdi-table-large mr-2"></i>GRN List</h4>  
                            <div class="">
                                <ol class="breadcrumb">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">GRN List</h4>
                                        <!-- <p class="text-muted mb-4 font-13">DataTables has most features enabled by
                                            default, so all you need to do to use it with your own tables is to call
                                            the construction function: <code>$().DataTable();</code>.
                                        </p> -->
        
                                        <table id="GRN-table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>GRN Number</th>
                                            ...
                                            ?>
                                            <tr onclick="location.href='grn_invoice_view?g=<?php echo (base64_encode($GRNDetailId)); ?>'" style="cursor: pointer;">
                                                <td><?php echo $GRNDetailId; ?></td>
                                                <td>AMAZOFT/GRN/<?php echo $GRNYear; ?>/<?php echo 1000+$GRNDetailId;?></td>
